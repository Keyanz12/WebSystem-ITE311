...
<body>
   ...
   <div class="sidebar">
      ...
      <div class="nav flex-column">
         ...
         <a class="nav-link active" href="<?= base_url('admin/courses') ?>">
   ...
   <div class="main-content">
      ...
      <div class="card">
         <div class="card-header bg-dark text-white">
            <h5><i class="bi bi-book"></i> Course Management</h5>
         </div>
         <div class="card-body">
            <p class="text-muted">Here you can manage all system courses, create new courses, and assign teachers.</p>
