         ...
         <div class="card-body">
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control" value="MyPortal LMS" readonly>
                        </div>
                        <div class="mb-3">
                           <label class="form-label">System Email</label>
                           <input type="email" class="form-control" value="admin@lmssystem.com" readonly>
                        </div>
                        <div class="mb-3">
                           <label class="form-label">Timezone</label>
                           <input type="text" class="form-control" value="UTC+08:00" readonly>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control" value="Strong (8+ chars)" readonly>
                        </div>
                        <div class="mb-3">
            ...
            <div class="row mt-3">
               <div class="col-md-12">
                  <div class="card">
                     <div class="card-header">
                        <h6><i class="bi bi-bell"></i> Notification Settings</h6>
                     </div>
                     <div class="card-body">
                        <p class="text-muted">Configure email notifications and system alerts.</p>
                        <button class="btn btn-primary" disabled>
                           <i class="bi bi-save"></i> Save Settings
                        </button>
                        <small class="text-muted ms-2">Settings functionality will be implemented in future updates.</small>
                     </div>
                  </div>
               </div>
            </div>
