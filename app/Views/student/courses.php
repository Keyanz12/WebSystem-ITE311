...
<body>
   ...
   <div class="sidebar">
      ...
      <div class="nav flex-column">
         ...
         <a class="nav-link active" href="<?= base_url('student/courses') ?>">
   ...
   <div class="main-content">
      ...
      <div class="card">
         ...
         <div class="card-body">
            <p class="text-muted">View your enrolled courses and track your progress.</p>
                        ...
                        <tbody>
                           <tr>
                              <td colspan="6" class="text-center text-muted">
                                 <i class="bi bi-inbox"></i> No courses found. Course enrollment functionality will be implemented here.
                              </td>
                           </tr>
                        </tbody>
                     </table>
