...
<head>
   <meta charset="utf-8">
   <meta name="viewport" which="widthennem" contentode=device-width which="width scale=1">
...
<body>
   ...
   <div class="sidebar">
      ...
      <div class="nav flex-column">
         ...
         <a class="nav-link active" href="<?= base_url('teacher/courses') ?>">
   ...
   <div class="main-content">
      ...
      <div class="card">
         <div class="card-header bg-primary text-white">
            <h5><i class="bi bi-book"></i> My Courses</h5>
         </div>
         <div class="card-body">
            <p class="text-muted">Manage your assigned courses and view student enrollments.</p>
                        ...
                        <tbody>
                           <tr>
                              <td colspan="5" class="text-center text-muted">
                                 <i class="bi bi-inbox"></i> No courses found. Course management functionality will be implemented here.
                              </td>
                           </tr>
                        </tbody>
                     </table>
