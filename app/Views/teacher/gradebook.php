...
<body>
   ...
   <div class="sidebar">
      ...
      <div class="nav flex-column">
         ...
         <a class="nav-link active" href="<?= base_url('teacher/gradebook') ?>">
   ...
   <div class="main-content">
      ...
      <div class="card">
         <div class="card-header bg-primary text-white">
            <h5><i class="bi bi-clipboard-check"></i> Grade Management</h5>
         </div>
         <div class="card-body">
            <p class="text-muted">Manage student grades and track academic performance.</p>
                        ...
                        <tbody>
                           <tr>
                              <td colspan="6" class="text-center text-muted">
                                 <i class="bi bi-inbox"></i> No grades found. Grade book functionality will be implemented here.
                              </td>
                           </tr>
                        </tbody>
                     </table>
