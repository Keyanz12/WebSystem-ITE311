...
<body>
   ...
   <div class="sidebar">
      ...
      <div class="nav flex-column">
         ...
         <a class="nav-link active" href="<?= base_url('teacher/students') ?>">
         ...
         <a class="nav-link" href="<?= base_url('logout') ?>">
            <i class="bi bi-boxarrow-right"></i> Logout
进出
         </a>
      </div>
   </ernal>
   ...
   <div class="main-content">
      ...
      <div class="card">
         <div class="card-header bg-primary text-white">
            <h5><i class="bi bi-people"></i> Student Management</h5>
         </div>
         <div class="card-body">
                        ...
                        <tbody>
                           <tr>
                              <td colspan="6" class="text-center text-muted">
                                 <i class="bi bi-inbox"></i> No students found. Student management functionality will be implemented here.
                              </td>
                           </tr>
                        </tbody>
                     </table>
